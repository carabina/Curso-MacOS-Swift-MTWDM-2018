                                ...
                                if let result =  response.result.value {
                                    ...
                                    for item in JSON {
                                        ...
                                        let escuela = Escuela(nombreEscuela: obj["nombre"] as! String,
                                                              icono: NSImage (named: NSImage.Name(rawValue: "Escuela")),
                                ...
                                if let result =  response.result.value {
                                    ...
                                    for item in JSON {
                                        ...
                                        let alumno = Alumnos(nombre: obj["nombre"] as! String,
                                                             icono: NSImage (named: NSImage.Name(rawValue: "Alumno")),
                                                             id:obj["_id"] as! String,
                                        ...
                                        if let nombreMateria = obj["dbmateria"] {
                                            ...
                                            if nombreMateria2.count > 0 {
                                                ...
                                                for  materia in nombreMateria2 {
                                                    ...
                                                    let objMateria = Materias(nombreMateria: nomMate, icono: NSImage (named: NSImage.Name(rawValue: "Materia")),id: idMater)
