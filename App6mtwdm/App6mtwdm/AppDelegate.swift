...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func GetViewController(storyboard: NSStoryboard,
        ...
        //como parametro
        //Main, Chat o Login
        return (storyboard.instantiateController(withIdentifier: NSStoryboard.SceneIdentifier(rawValue: viewControllerName)) as? NSViewController)
    ...
    func SetRootViewController(rootViewController:NSViewController?)  {
        ...
        if let aController = rootViewController {  //Login o Chat
            rootViewController?.presentViewControllerAsModalWindow(aController)
        }
